...
![OU Structure](/lab-02-users-groups-permissions/screenshots/01-ad-it-hr-sales-dc-01.png)

## Phase 2: Users & Groups
- Created departmental Security Groups: `IT_Admins`, `HR_Staff`, and `Sales_Team`.
- Added two users per OU (e.g., `s-monroe / Sales Monroe`, `s-borne / Sales Borne`, `hr-giger / H.R. Giger`). 
...
![Group Membership](/lab-02-users-groups-permissions/screenshots/02-group-membership-dc-01.png)
...
![HR Lockdown](/lab-02-users-groups-permissions/screenshots/03-ntfs-lockdown-hr-dc-01.png) ![IT Lockdown](/lab-02-users-groups-permissions/screenshots/03-ntfs-lockdown-it-dc-01.png) ![Sales Lockdown](/lab-02-users-groups-permissions/screenshots/03-ntfs-lockdown-sales-dc-01.png)
...
![Initial Access Error](/lab-02-users-groups-permissions/screenshots/04-no-access-shared-folder-user-01.png)
...
![Network Path Access](/lab-02-users-groups-permissions/screenshots/05-network-path-user-01.png) ![Write Success](/lab-02-users-groups-permissions/screenshots/06-sales-create-file-test-user-01.png)
...
![Access Denied Proof](/lab-02-users-groups-permissions/screenshots/07-access-denied-hr-folder-sales-user-01.png)
