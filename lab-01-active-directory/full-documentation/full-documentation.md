...
![VirtualBox Network Configuration](/lab-01-active-directory/screenshots/01-vbox-network-dc-01.png)
...
![DC-01 Desktop](/lab-01-active-directory/screenshots/02-desktop-dc-01.png) ![USER-01 Desktop](/lab-01-active-directory/screenshots/02-desktop-user-01.png)
...
![DC-01 IPv4 Config](/lab-01-active-directory/screenshots/03-ipv4-config-dc-01.png) ![USER-01 IPv4 Config](/lab-01-active-directory/screenshots/03-ipv4-config-user-01.png)

### 3. IP Verification
- Verified active configurations via `ipconfig`.

![DC-01 ipconfig](/lab-01-active-directory/screenshots/04-ipconfig-dc-01.png) ![USER-01 ipconfig](/lab-01-active-directory/screenshots/04-ipconfig-user-01.png)
...
![Firewall Rule](/lab-01-active-directory/screenshots/05-firewall-icmp-rule-dc-01.png) 
    
- **Validation:** Successfully verified connectivity by pinging `192.168.10.10` from the `USER-01` Command Prompt.

![Successful Ping Test](/lab-01-active-directory/screenshots/06-ping-test-success-user-01.png)
...
![AD DS Role Selection](/lab-01-active-directory/screenshots/07-ad-ds-role-selection-dc-01.png)
...
![New Forest Setup](/lab-01-active-directory/screenshots/08-new-forest-setup-dc-01.png)
...
![Prerquisites Check Passes](/lab-01-active-directory/screenshots/09-prereq-check-passed-dc-01.png)
...
![Domain Login Screen](/lab-01-active-directory/screenshots/10-dc-login-screen-dc-01.png) ![Server Manager AD Active](/lab-01-active-directory/screenshots/11-server-manager-ad-active-dc-01.png)
...
![OU Structure](/lab-01-active-directory/screenshots/12-ou-structure-dc-01.png)
...
![Admin User Group](/lab-01-active-directory/screenshots/13-admin-user-group-dc-01.png)
...
![Domain Join](/lab-01-active-directory/screenshots/14-domain-join-user-01.png)
...
![Domain Login Screen](/lab-01-active-directory/screenshots/15-domain-login-user-01.png)
...
![Domain Identity Verification](/lab-01-active-directory/screenshots/16-connectivity-test-user-01.png)
...
![AD Management](/lab-01-active-directory/screenshots/17-ad-verification-dc-01.png)
